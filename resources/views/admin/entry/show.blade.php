...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">&nbsp;Entry Detail</h3>
      <div class="box-tools">
	...
	<div class="box-footer">
	    <a href="{{ route('entry.edit', $register->id) }}" class="btn btn-default pull-left">Edit</a>
		<form action="{{ route('entry.destroy', $register->id) }}" class="form-horizontal" method="post">
			{!! csrf_field() !!}
