    ...
    */
    ...
    'grant_types' => [
        ...
        'refresh_token' => [
            ...
            'access_token_ttl' => 604800, // Quanto tempo dura o token desejado com duração de 3600 segundos
            'refresh_token_ttl' => 604800 // Toda vez que gera um token gera um refresh token com duração de 36000 segundos
        ]
    ],
