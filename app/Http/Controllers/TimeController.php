...
class TimeController extends Controller
{
    ...
    public function index()
    {
        ...
        $parcelas = \Helpers::MontaParcelas($parcelas,0);
        ...
        $years = \Helpers::MontaDrop('year',$years,date('Y'));
        ...
        $months = \Helpers::MontaDrop('month',$months,date('m'));
        ...
        $cartoes = \Helpers::MontaCartoes($cartoes,'Mastercard');
